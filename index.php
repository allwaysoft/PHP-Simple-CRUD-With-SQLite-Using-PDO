...
<body>
	...
	<div class="col-md-6 well">
		...
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span class="glyphicon glyphicon-plus"></span>添加</button>
		<br /><br/ >
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><button class="btn btn-warning" type="button" data-toggle="modal" data-target="#update_student<?php echo $fetch['student_id']?>"><span class="glyphicon glyphicon-edit"></span> 编辑</button> <a href="delete.php?id=<?php echo $fetch['student_id']?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>删除</a></td>
				</tr>
